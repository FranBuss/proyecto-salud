...
/*
    ...
    public void addAppointment(Appointment appointment, Professional professional, Patient patient, LocalDateTime appointmentDateTime, String comments){

        appointment.setPatient(patient);
        appointment.setProfessional(professional);
        appointment.setAppointment(appointmentDateTime);
